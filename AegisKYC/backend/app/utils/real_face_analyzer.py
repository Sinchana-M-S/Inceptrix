...
# Try to import MediaPipe (may not work on Python 3.13+ or MediaPipe 0.10.31+)
MEDIAPIPE_AVAILABLE = False
mp = None
try:
    import mediapipe as _mp
    # MediaPipe 0.10.31+ removed .solutions; use fallback if missing
...
if not MEDIAPIPE_AVAILABLE:
    print("Warning: MediaPipe not available (or legacy API removed). Using OpenCV fallback for face detection.")
