...
print("[OK] All collections created with indexes successfully!")
print(f"[OK] Total collections: {len(db.list_collection_names())}")
print("[OK] Collections: Users, KYCRequests, Documents, Biometrics, RiskScores, BehavioralSignals, DeviceMetadata, AuditLogs, Sessions, ConsentLedger, SecurityEvents, Analytics")
